...
class CloudSpeechClient:
    ...
    """
    def __init__(self, service_accout_file=None, board=None):
    ...
    def recognize_bytes(self, data, language_code='fr-FR', hint_phrases=None):
        """
    ...
    def recognize(self, language_code='en-US', hint_phrases=None):
        ...
        with Recorder() as recorder:
            logging.info('recorder launched')
            ...
            logging.info('stop recognize')
                    
            for response in responses:
                if response.speech_event_type == END_OF_SINGLE_UTTERANCE:
                    #logging.info('res type'+ response.speech_event_type)
                    recorder.done()
